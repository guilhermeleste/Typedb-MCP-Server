...
/// Implementação de verificador de certificados que aceita qualquer certificado.
/// Usado apenas em testes para aceitar certificados autoassinados/de teste.
#[derive(Debug)]
...
impl ServerCertVerifier for NoVerification {
    fn verify_server_cert(
        ...
        // Aceitar qualquer certificado em testes
    ...
    fn verify_tls12_signature(
        ...
        // Aceitar qualquer assinatura em testes
...
impl TestMcpClient {
    ...
    async fn connect_websocket(
        ...
        let connect_future: BoxFuture<'_, Result<_, _>> = if is_wss {
            ...
            debug!("TestMcpClient: Conexão WS regular, sem TLS");
